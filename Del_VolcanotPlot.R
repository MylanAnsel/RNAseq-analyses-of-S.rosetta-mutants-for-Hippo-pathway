...
output_dir <- "W:/mansel/RNAseq/For_publication/KO_Deletion/output_R_analyses/VolcanoPlot"
...
input_conditions_paths <- list(
  ...
  Strict_WT_Warts = "W:/mansel/RNAseq/For_publication/KO_Deletion/output_R_analyses/Heatmap/filtered_deg_lists/Warts_strict_filtered_DEGs.txt",
